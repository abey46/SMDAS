...
<body>
    ...
    <p><strong>Slide right to unlock door</strong></p>
    ...
    <div><form onsubmit="return createOutput();">
        ...
        <p><strong>Note:</strong> for some device, it might be need to refresh the page to see your newly created buttons or to remove deleted buttons.</p>
    </form></div>
